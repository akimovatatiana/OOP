...
BOOST_AUTO_TEST_CASE(point_can_get_x_value)
{
	BOOST_CHECK_EQUAL(point.x, 10.05);
}
BOOST_AUTO_TEST_CASE(point_can_get_y_value)
{
	BOOST_CHECK_EQUAL(point.y, 15.26);
}
BOOST_AUTO_TEST_CASE(point_can_get_x_and_y_values)
{
...
BOOST_AUTO_TEST_CASE(circle_can_get_center)
{
	BOOST_CHECK(circle.GetCenter().x == 10);
	BOOST_CHECK(circle.GetCenter().y == 9);
}
BOOST_AUTO_TEST_CASE(circle_can_get_radius)
{
